...
/** Heat the reaction gives off. Doubles roughly every 15 °C. */
const heatMade = (t: number) => 6 * Math.exp((t - 60) / 22);
/** Heat the jacket pulls out. A straight line — it only depends on the gap. */
const heatTaken = (t: number, power: number) =>
  (0.6 + (power / 100) * 4.4) * (t - 25);
