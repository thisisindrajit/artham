/**
 * Tailwind recipes for the few surfaces that repeat across the app.
 *
...
export const buttonPrimary =
  "bg-primary text-primary-ink shadow-[0_4px_0_var(--press),0_12px_24px_rgba(23,23,23,0.22)] transition duration-200 ease-[var(--ease-bounce)] " +
  "hover:not-disabled:-translate-y-0.5 hover:not-disabled:bg-black hover:not-disabled:shadow-[0_6px_0_var(--press),0_16px_30px_rgba(23,23,23,0.28)] " +
  "active:not-disabled:shadow-[0_1px_0_var(--press),0_4px_10px_rgba(23,23,23,0.2)] " +
  "focus-visible:outline-3 focus-visible:outline-offset-3 focus-visible:outline-accent/75 " +
